...
final class Swift_ISO8601_DurationParserTests: XCTestCase {
    ...
    func testDurationStringNotStartingWithPReturnsNil() {
        let dateComponents = DateComponents.durationFrom8601String(durationString: "3Y6M4DT12H30M5S")
        let dateComponents2 = DateComponents.durationFrom8601String(durationString: "8W")
